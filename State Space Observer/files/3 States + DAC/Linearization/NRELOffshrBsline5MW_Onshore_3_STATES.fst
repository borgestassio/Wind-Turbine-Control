...
1170     VS_RtGnSp   - Rated generator speed for simple variable-speed generator control (HSS side) (rpm) [used only when VSContrl=1]
...
9999.9      TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
   10.0      BlPitch(1)  - Blade 1 initial pitch (degrees)
   10.0      BlPitch(2)  - Blade 2 initial pitch (degrees)
   10.0      BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades]
