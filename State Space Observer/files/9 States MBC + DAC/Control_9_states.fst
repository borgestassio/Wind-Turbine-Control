...
---------------------- INPUT FILES ---------------------------------------------
"5MW_Baseline_lin/NRELOffshrBsline5MW_Onshore_ElastoDyn_9_states.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"5MW_Baseline_lin/NRELOffshrBsline5MW_Onshore_ServoDyn_9_states.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
