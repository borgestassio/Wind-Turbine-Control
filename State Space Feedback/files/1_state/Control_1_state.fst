...
---------------------- INPUT FILES ---------------------------------------------
"5MW_Baseline_lin/NRELOffshrBsline5MW_Onshore_ElastoDyn_1_state.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"5MW_Baseline_lin/NRELOffshrBsline5MW_Onshore_ServoDyn_1_state.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
