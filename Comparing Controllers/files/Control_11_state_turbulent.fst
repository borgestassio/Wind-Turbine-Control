...
---------------------- INPUT FILES ---------------------------------------------
"5MW_Baseline_lin/NRELOffshrBsline5MW_Onshore_ElastoDyn_11_state.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"5MW_Baseline_lin/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"5MW_Baseline_lin/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"5MW_Baseline_lin/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"5MW_Baseline_lin/NRELOffshrBsline5MW_InflowWind_turbulent.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"5MW_Baseline_lin/NRELOffshrBsline5MW_Onshore_AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"5MW_Baseline_lin/NRELOffshrBsline5MW_Onshore_ServoDyn_11_state.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
